...
**Applies to:** AGX, AGW, AGW repositories
**Version:** 1.0
...
- Title format: `AGW-XXX: Description` (or `AGX-XXX`, `AGW-XXX`)
...
3. **Upload Assets**
   - `agw-macos-arm64.tar.gz` + checksum
   - `agw-macos-x86_64.tar.gz` + checksum
   - `agw-linux-x86_64.tar.gz` + checksum
   - `agw-linux-arm64.tar.gz` + checksum
...
```markdown
![CI](https://github.com/agenix-sh/agw/workflows/CI/badge.svg)
![Security Audit](https://github.com/agenix-sh/agw/workflows/Security%20Audit/badge.svg)
[![codecov](https://codecov.io/gh/agenix-sh/agw/branch/main/graph/badge.svg)](https://codecov.io/gh/agenix-sh/agw)
```
